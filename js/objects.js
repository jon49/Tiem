...
//   }
   ...
   var addCurrentJobSetting = function(theseJobSettings){
      ...
      theseJobSettings.list = _.reject(theseJobSettings.list, function(item){
...
//   }
   ...
   var changeJobName = function(name){
      this.current[Tiem.k.jobName()] = name
      return addCurrentJobSetting(this)
   }
   
   var changeJobActive = function(active){
      this.current[Tiem.k.jobActive()] = active
      return addCurrentJobSetting(this)
   }
