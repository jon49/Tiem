...
var Option, L, ClockState, Job, t, o;
...
describe('How Job model is used:', function(){
  ...
  describe('The function `isClockedIn`', function(){
    var x$;
    x$ = it;
    x$('should determine if Job Option is clocked in', function(){
      var jobIn;
      jobIn = Option.Some(Job.create(0, '', [clockState]));
      expect(Job.isClockedIn(jobIn)).toBe(true);
    });
    x$('should determine if Job Option is clocked out', function(){
      var jobOut;
  ...
  describe('The function `with`', function(){
    ...
    x$('should update the comment and return a new object', function(){
      expect(Job['with'](job, {
        comment: 'New Comment.'
      })).toEqual(Option.Some(Job.create(0, 'New Comment.', [clockState])));
