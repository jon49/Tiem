...
/* brackets-xunit: includes=../bower_components/lodash/dist/lodash.js,../bower_components/bilby.js/bilby.js,../bower_components/mithril/mithril.js,utilities.js,engine.js,objects.js,controller.js,events.js */
//,ui.js
...
describe('Job Setting object manipulation', function(){
   ...
   describe('the method create', function(){
      it('should create a new instance of Job Setting', function(){
         expect(b.isInstanceOf(JobSetting, newJobSetting)).toBe(true)
         expect(newJobSetting[t.k.id()]).toBe(id)
         expect(newJobSetting[t.k.name()]).toBe('I love my job')
   ...
   describe('the function update', function(){
      it('should be able to update the job name', function(){
         expect(newJobSetting.update('New Job Name').getOrElse({})).toEqual({id:id, name:'New Job Name', jobActive: true})
      })
...
//         settings = settings.add(newJobSetting).add(job2)
